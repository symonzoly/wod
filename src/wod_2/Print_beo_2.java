...
public class Print_beo_2 extends Adatbazis {
	//1
	ResultSet rs0;
	...
	public Print_beo_2(int azon, String passw, String jog) throws ClassNotFoundException, SQLException {
		
		kapcsolat();
		
//1 eleje
		rs0=st.executeQuery("SELECT d1,d2,d3,d4,d5,d6,d7 FROM beosztas "
				+ "JOIN user_login ON beosztas.a_ID LIKE user_login.a_ID "
				+ "WHERE beosztas.a_ID LIKE "+azon+" AND user_login.passw LIKE '"+passw+"' AND jogosultsag = '"+jog+"'");
